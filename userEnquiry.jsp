            ...
            <div id="page-inner">
                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                        ...
                        <div class="">
                            <form id="form"  method="post"  name="enquiry">
                                        <div class="form-group">                                       	
                                            <label>Please choose your card account number</label>
                                            <select class="form-control" id="cardNumber" name="cardNumber" required="required">
	                                  ...
	                                  <button type="submit" class="btn btn-info" value="1" onclick="submitFun(this.value)">Balance Enquiry </button>
									  <button type="submit" class="btn btn-info" value="2" onclick="submitFun(this.value)" style="margin-left:20px">Time-Deposit Enquiry </button>
                            </form>                                                       
                            </div>
                        </div>  
                        <div class="col-md-1"></div>                     
